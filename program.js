...
window.PROGRAM = {
  ...
  "notes": [
    ...
    { "label": "Mesures", "text": "1RM lesté saisi (40 kg le 24 août), poids de corps suivi (82,8 kg le 31 août, -1 depuis le départ). Le MAX REPS — le graphique qui porte l'objectif du cycle, 17 → 25 — est TOUJOURS VIDE après huit semaines, alors qu'il y a maintenant TROIS valeurs écrites dans tes remarques de séance : 20 reps le 14 août (test S4), 21 reps le 26 août (ouverture du mercredi S6), 20 reps le 2 septembre (ouverture du mercredi S7). Ces trois points racontent quelque chose d'utile — le max reps stagne pendant que le lesté monte de 5 kg, ce qui est le comportement normal d'un bloc de force max — mais tant qu'ils ne sont pas saisis, la comparaison S4 → S9 → S13 n'existe pas. NEUVIÈME CYCLE : l'export du 14 septembre affiche toujours « Aucune mesure enregistrée » sur ce graphique, et le poids de corps n'a plus bougé depuis le 31 août. Cinq minutes le vendredi 18 septembre, avec les trois chiffres du test — sans elles, le bilan de fin de cycle se résumera à « 17 au départ, X à la fin » alors que le carnet contient de quoi tracer toute la courbe. Le 1RM dips (57,5 kg le 14 août) n'a pas de graphique mais reste noté ici." },
  ...
  "weeks": [
    ...
    [
      ...
      { "day": 2, "type": "deload", "title": "Récup — le 1RM est passé, le vendredi reste à faire", "ex": [
        "Le test du mercredi est parti au lundi : cette journée ne sert plus qu'à arriver frais au vendredi. Aucune séance lourde, aucune série max.",
        "Au choix : repos complet · 30-40 min de course VRAIMENT facile · ou mobilité + gainage 20 min",
        "Interdits jusqu'à vendredi : dead hang lourd, false grip, soulevé de terre, escalade, dips lestés. Le vendredi teste le muscle-up, le max reps ET les dips — trois lignes qui passent toutes par la prise et les épaules.",
        "Si les tractions du lundi ont laissé les avant-bras raides : bras en l'air, c'est normal après un 1RM, ça part en 48 h. Repos complet dans ce cas."
      ]},
      { "day": 4, "type": "test", "title": "Test 2/2 — muscle-up, max reps & dips", "ex": [
        "PLANIFIE CE VENDREDI comme le 1RM : reposé, pas en fin de journée épuisante. Avec le test avancé au lundi, tu as QUATRE jours de récupération devant cette séance au lieu de deux — c'est le meilleur contexte de tout le cycle pour un max reps.",
        "CETTE SÉANCE-LÀ NE SE SAUTE PAS. C'est le point faible mesuré du carnet : le vendredi est la séance qui saute (trois vendredis sur quatre écourtés en phase 2, et celui du 11 septembre annulé en entier). Or c'est elle qui porte les deux chiffres du cycle — le max reps, jamais saisi dans « Ma progression » depuis le 20 juillet, et le muscle-up, qui décide du contenu de la phase 3. Si le vendredi tombe à l'eau, tu la fais le SAMEDI 19 ; jamais le même jour que des singles lourds, qui coûtent 2 à 4 reps au max reps — c'est toute la raison d'être du découpage en deux jours.",
