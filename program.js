  ...
  "weeks": [
    ...
    [
      { "day": 0, "type": "deload", "title": "Activation — la semaine de test commence", "ex": [
        "LE RAPPEL D'INTENSITÉ DE VENDREDI DERNIER N'A PAS ÉTÉ FAIT (« pas fait, repos ») : il tombe donc entièrement aujourd'hui. Depuis le 31 août tu n'as plus rien touché au-dessus de 88 % — ça fera 16 jours mercredi. Séance très courte, 7 reps en tout, mais avec du lourd dedans : un taper coupe le volume, pas l'intensité (note « Deload & taper »).",
        ...
        "3) PUIS UN SEUL single @30 kg (92 %), 4 min de repos avant — c'est le rappel du vendredi manqué, pas une tentative. VITESSE, jamais à l'échec, et s'il monte lentement tu ne le refais pas : le chiffre se mesure mercredi, pas ce soir.",
        "4) Tractions explosives 3x3 au poids de corps, jambes strictement immobiles — sec, rien à l'échec",
      ...
      { "day": 1, "type": "deload", "title": "Jambes — mobilité seulement (veille du test)", "ex": [
        ...
        "Rappel, parce que la consigne a sauté la semaine dernière : le mardi de la S8 a vu un deadlift 4x10 @60 kg ajouté (« très facile ») alors que la semaine interdisait le SDT. Sans conséquence à 8 jours du test — mais à 24 h, non."
      ]},
      { "day": 2, "type": "test", "title": "Test 1/2 — 1RM lesté tractions", "ex": [
        ...
        "ÉTAT RÉEL DU TAPER : deux semaines sans séance lourde de volume, et les trois séances de décharge de la S8 toutes notées « Facile » — c'est exactement ce qu'une décharge doit produire. Côté intensité en revanche, il ne reste qu'un rappel au lieu de deux : celui du vendredi 11 n'a pas été fait, tout est passé au lundi 14 (3x2 @25 + un single @30). Si ça ne sort pas aujourd'hui, ce n'est pas la récupération qui aura manqué ; et si la première montée te paraît « lente mais solide », c'est normal après 16 jours sans très lourd — ça se débloque au palier suivant, ne redescends pas la charge pour ça.",
